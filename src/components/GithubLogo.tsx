/** lucide dropped its brand icons, so the GitHub mark is inlined (matches the X mark pattern in Testimonials.tsx). */
export default function GithubLogo({ className = "size-4" }: { className?: string }) {
  return (
