...
export const Eye = outline([
  "M15.58 12a3.58 3.58 0 1 1-7.16 0 3.58 3.58 0 0 1 7.16 0Z",
  "M12 20.27c4.7 0 8.7-2.9 10.3-8.27C20.7 6.63 16.7 3.73 12 3.73S3.3 6.63 1.7 12c1.6 5.37 5.6 8.27 10.3 8.27Z",
]);
export const EyeOff = outline([
  "M14.53 9.47a3.58 3.58 0 0 0-5.06 5.06",
  "M17.82 6.18C16.16 4.87 14.18 3.98 12 3.73c-4.4-.5-8.36 2.4-9.94 7.5-.28.9-.28 1.87 0 2.77.5 1.6 1.32 2.98 2.36 4.09",
  "M8.42 19.13c1.12.5 2.33.79 3.58.79 4.4.5 8.36-2.4 9.94-7.5.28-.9.28-1.87 0-2.77-.42-1.35-1.03-2.55-1.8-3.55",
  "M2 2l20 20",
]);
